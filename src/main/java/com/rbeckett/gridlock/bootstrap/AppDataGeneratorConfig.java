...
public class AppDataGeneratorConfig {
    ...
    public static final int NUM_OS_CONFIGURATIONS = -1;//NUM_NETWORK_CONFIGURATIONS;
    public static final int NUM_NETWORK_CONNECTIONS = -1;//NUM_NETWORK_CONFIGURATIONS * 3;
}
